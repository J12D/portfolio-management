\documentclass[11pt, parskip=full, DIV=14, headings=small, footsepline, footinclude=false, headsepline]{scrreprt}
...
\ohead{\includegraphics[height=5mm]{jdlogo.jpg}}
\ihead{\includegraphics[height=5mm]{jdlogo.jpg}}
\ofoot{\includegraphics[height=5mm]{jdlogo.jpg}}
\ifoot{\includegraphics[height=5mm]{jdlogo.jpg}}

\RedeclareSectionCommands[
  afterskip = 1.35\baselineskip plus .09\baselineskip minus .15\baselineskip,%
...
{\color{black}\topb} \\[\baselineskip]
\textcolor{lightblue}{\CP} \\[\baselineskip]
%{\color{black}\LARGE JD Investments} \\
...
%Minimum Variance & 1.37 & 10.92 & 7.99 & 5.29 & 11.56 & 0.06 & 0.28 \\ 
 %Maximum Sharpe & 1.46 & 17.55 & 12.05 & 8.98 & 11.94 & 0.06 & 0.26 \\ 
 %Fixed Weights Leveraged & 1.54 & 21.47 & 13.95 & 9.83 & 0.00 & 0.00 & 0.76 \\ 
 %Maximum Sharpe Robust & 1.12 & 16.55 & 14.82 & 7.70 & 44.45 & 0.22 & 0.26 \\ 
 %MV Max Allocation & 1.40 & 5.18 & 3.70 & 2.50 & 4.65 & 0.02 & 0.19 \\ 
 \bottomrule
\end{tabular}
\end{table}
...
\begin{tikzpicture}
  \begin{axis}[w={0}{180}, stack plots = false,xmin={2013-01-01}, xmax={2015-06-30}, ymin = 95, legend columns = 1]
...
\begin{tabular}{lrrrrrr}
  \toprule
 & Sharpe & $\mu$[\%] & $\sigma$[\%]& Inf. Ratio & Appraisal Ratio\\
  \midrule
   Mean Variance+ & -1.03 & -3.93 & 3.80 & -1.08 & 0.16\\ 
   Equal Risk Contribution & -0.81 & -11.30 & 13.90 & -0.81 & 0.14\\ 
   Market View Optimized & -1.20 & -22.38 & 18.64 & -2.11 & 0.11\\ 
   Low Risk Robust& -1.38 & -25.32 & 18.34 & -2.24 & 0.12\\ 
   Fixed Weights & -1.20 & -22.38 & 18.64 & -2.04 & 0.12\\ 
...
\begin{tikzpicture}
  \begin{axis}[w={80}{110}, stack plots = false, xmin={2015-06-30}, xmax={2015-10-31}, xtick={2015-07-01, 2015-08-01, 2015-09-01, 2015-10-01, 2015-11-01}, xticklabel={\pgfcalendar{tickcal}{\tick}{\tick}{\pgfcalendarshorthand{m}{.}}}, legend columns = 1]
    ...
    \addlegendentry{Low Risk Robust}
    \addplot[total, black] table[x=time, y= value.Mean.Variance..Equity.Fund] {plot-data/comparison_bonus.txt};
    \addlegendentry{Mean Variance+}
