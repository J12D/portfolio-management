...
\begin{center}
\def\CP{\textit{\Huge Portfolios for a safe future}}
...
\newtcolorbox{mybox}[1]{
   ...
   right=0pt,
   width=.48\textwidth,
   enlarge left by=.02\textwidth,
   coltitle=black,
   frame code={},
   interior titled code={
     \draw[dbblue,ultra thick] 
...
\item Covariance shrinkage based on market views (using Black-Litterman)
\item No short-sales
\end{sit}
