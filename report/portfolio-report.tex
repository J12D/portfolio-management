...
\newpage\section*{5 -- Black Litterman}
\begin{tikzpicture}
  \begin{axis}[w={0}{170}, y filter/.code={\pgfmathparse{max(#1,0)}\pgfmathresult}]
...
\newpage\section*{7 --- Min Variance Robust}
\begin{tikzpicture}
  \begin{axis}[w={0}{170}, y filter/.code={\pgfmathparse{max(#1,0)}\pgfmathresult}]
...
\newpage\section*{10 --- Mean Variance with Maximum Allocation and Short-Sale Constraint}
\begin{tikzpicture}
  \begin{axis}[w={0}{170}, y filter/.code={\pgfmathparse{max(#1,0)}\pgfmathresult}]
